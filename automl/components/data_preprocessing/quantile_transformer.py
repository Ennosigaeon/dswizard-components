...
class QuantileTransformerComponent(PreprocessingAlgorithm):
    ...
    def __init__(self, n_quantiles: int = 1000, output_distribution: str = "uniform", ignore_implicit_zeros: bool = False, subsample: int = 1e5, random_state=None):
        super().__init__()
        ...
        self.preprocessor = QuantileTransformer(n_quantiles=self.n_quantiles,
