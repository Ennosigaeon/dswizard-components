...
class GenericUnivariateSelectComponent(PreprocessingAlgorithm):
    ...
    def __init__(self, alpha: float = 0.5, score_func: str = "chi2", mode: str = "percentile"):
        super().__init__()
        self.alpha = alpha
        self.mode = mode
    ...
    def fit(self, X, y=None):
        ...
        self.preprocessor = GenericUnivariateSelect(param=self.alpha,mode=self.mode,score_func=self.score_func)
