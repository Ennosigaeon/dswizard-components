...
class SGDClassifier(PredictionAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        alpha = UniformFloatHyperparameter("alpha", 0., 1., default_value=0.001)
        ...
        max_iter = UniformIntegerHyperparameter("max_iter", 20, 10000, default_value=1000)
        tol = UniformFloatHyperparameter("tol", 1e-6, 1e-1, default_value=1e-3)
        shuffle = CategoricalHyperparameter("shuffle", [True, False], default_value=True)
        epsilon = UniformFloatHyperparameter("epsilon", 1e-7, 10, default_value=0.1)
        learning_rate = CategoricalHyperparameter("learning_rate", ["constant", "optimal", "invscaling", "adaptive"],
                                                  default_value="optimal")
        eta0 = UniformFloatHyperparameter("eta0", 0., 1., default_value=0.)
        power_t = UniformFloatHyperparameter("power_t", 1e-7, 0.9999, default_value=0.5)
