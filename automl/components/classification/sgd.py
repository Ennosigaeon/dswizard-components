...
class SGDClassifier(PredictionAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        alpha = UniformFloatHyperparameter("alpha", 1e-7, 50., default_value=0.001, log=True)
        ...
        max_iter = UniformIntegerHyperparameter("max_iter", 20, 2500, default_value=1000)
        ...
        power_t = UniformFloatHyperparameter("power_t", 1e-9, 1, default_value=0.5)
